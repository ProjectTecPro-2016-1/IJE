...
const Rect& Object::bounding_box() const {
...
void Object::set_w(double w) {
    m_impl->set_w(w);
}

void Object::set_h(double h) {
    m_impl->set_h(h);
}
...
void Object::set_dimensions(double w, double h) {
...
bool Object::send_message(Object *receiver, MessageID id, Parameters parameters) {
    return m_impl->send_message(receiver, id, parameters);
}

bool Object::on_message(Object *, MessageID, Parameters) {
    return false;
}

void Object::add_observer(Object *observer) {
    m_impl->add_observer(observer);
}

void Object::remove_observer(Object *observer) {
    m_impl->remove_observer(observer);
}

void Object::notify(ActionID action, Parameters parameters) {
    m_impl->notify(action, parameters);
}

void Object::update(unsigned long elapsed) {
...
void Object::update_self(unsigned long) {
}

void Object::draw_self() {
}

void Object::align_to(const Object* object, Alignment xaxis, Alignment yaxis) {
